                        ...
                        load: function(store, data) {
                            if (data && data.length) {
                                Ext.Array.each(data, function(x) {
                                    ...
                                    if (x.raw.Release.Notes) gridData[x.raw.Release._refObjectName].Notes.push('<b>' + x.raw.Project._refObjectName + '</b>: ' + Rally.util.String.stripHTML(x.raw.Release.Notes));
                                });
                                loader.nextPage();
                            } else {
                                callback();
                ...
                App.down('#viewport').add({
                    ...
                    listeners: {
                        itemclick: function(view, record, item, index, evt) {
                            ...
                            if (column == 2) {
                                showPopup('User Stories','US_Store',[
                                    ...
                                    { text: 'State',         dataIndex: 'ScheduleState', width: 75  },
                            ...
                            function showPopup(title, store, columns) {
                                if (record.get(store).length == 0) return;
