...
Ext.define('CustomApp', {
						...
						Ext.Array.each(roots, function(root) {
							getDescendants(root.get('ObjectID'), function(descendants) {
								...
								nodes.push({
									...
									text        : '<span class="count">' + descendants.length + '</span> - ' + root.get('Name'),
														...
														Ext.Array.each(children, function(child) {
															getDescendants(child.get('ObjectID'), function(descendants) {
																...
																newNodes.push({
																	name        : child.get('Name'),
																	childFilter : childFilter,
																	text        : '<span class="count">' + descendants.length + '</span> - ' + child.get('Name'),
    ...
    viewport: {
    	...
    	update: function() {
			...
			var filter              = [];
			var qCount              = 0;
			var descendantOIDs      = App.rpmTree.getAllDescendants();
