...
Ext.define('CustomApp', {
    ...
    viewport: {
    	update: function() {
            ...
            if (!xStart || !xEnd) {
                //Ext.Msg.alert('Error', 'The selected project does not have a planned start and end date defined. A range of the past 30 days will be used until these properties are set.');
